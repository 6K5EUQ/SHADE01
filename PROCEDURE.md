...
**읽히지 않는 로그와 arm 하자마자 disarm 한 것(6초 이하)은 안 올라간다.**
목록에 회색 줄만 남기기 때문이다. 지상 시험(`ground`)은 올라간다 — 진동·전류
점검에 쓴다. 판정 기준은 [web/README.md](web/README.md#올릴-값이-없는-로그는-안-올라간다-2026-09-05).
