...
**① 전원 입력 ↔ [PDB 300A](../../power/holybro-pdb-300a-side-entry/README.md#-pdb--esc-커넥터-불일치--납땜-개조로-해소-2026-08-31-완료) — ✅ 납땜 개조로 해소 (2026-08-31)**

본 ESC의 전원 입력은 원래 **OT2.5-4 링터미널**이고 PDB의 ESC 출력단은 **XT90**이라 그대로는 연결할 수 없었다. 링터미널을 잘라내고 커넥터를 **직접 납땜**하여 해소했다. 상세는 PDB 문서 참조.
