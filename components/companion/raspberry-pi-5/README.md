...
> ### ⚪ raspb1 은 휴면이다 (2026-09-04~) — FC USB 는 `rim3` 에 있다
>
> 아래 "현재 링크 구성" 은 **8/31~9/3 의 구성**이다. 9/4 에 FC USB 를 `rim3` 로 옮겼고
> raspb1 은 Tailscale 에서도 offline 이다. 비행 링크는 ELRS 백팩이고 raspb1 은 필수가
> 아니다 — 현행 3경로는 [README 링크 구성](../../../README.md#링크-구성--3-경로).
> 다시 살리는 때는 백팩 사거리를 넘는 원격 텔레메트리가 필요해질 때다.
>
