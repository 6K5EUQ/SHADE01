...
|---|---|---|---|---|
| SC 위 + SF 딸칵 | 1000us | −1024 | 1 | `MISN` |
| **SB 위** | **1275us** | **−461** | 2 | **`STAB`** |
| SB 중간 | 1425us | −154 | 3 | `ALT` |
| SB 아래 | 1500us | 0 | 4 | `POS` |
| SC 아래 + SF 딸칵 | 2000us | +1024 | 6 | `RTL` |
...
⚠️ **슬롯 2 는 1282us 경계에서 7us 위**에 있다. RC 캘리브레이션이나 믹스 변경이 그 값을
밀면 배너도 `POS` 로 따라 넘어간다 — 그게 의도한 동작이다. 화면은 스위치에 적힌 이름이
아니라 **FC 가 실제로 나는 모드**를 보여야 한다.
